...
//      SystemNavigator.pop();
  ...
  Widget _buildFileItem(FileSystemEntity file) {
    String modifiedTime = DateFormat('yyyy-MM-dd HH:mm:ss')
    ...
    return InkWell(
      ...
      onTap: () {
        if (widget.fileManagerType == FileManagerType.GetPath) {
  ...
  Widget _buildFolderItem(FileSystemEntity file) {
    ...
    return InkWell(
      child: Container(
        ...
        child: ListTile(
          leading: Image.asset('assets/images/file/folder.png'),
          title: Row(
            children: <Widget>[
              Expanded(
                  child:
  ...
  Future openFile(String path) async {
    ...
    FlutterFileManager.openFile(args);
  }
}
